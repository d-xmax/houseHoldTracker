...
export function SettingsPanel({
  ...
  const normalizedInitial =
    useMemo<UserSettingsState>(
      () => ({
        fullName:
          initialSettings?.fullName ??
          'Household Admin',
        email:
        ...
        timezone:
          ...
          'Pacific Time (PT)',
        enableReminders:
          initialSettings?.enableReminders ??
          true,
        weeklyDigest:
          initialSettings?.weeklyDigest ?? false,
      }),
      [initialSettings],
    );
  ...
  const updateSetting = <
    K extends keyof UserSettingsState,
  >(
    key: K,
    ...
    <section className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            list collaborators know who is on
            duty.
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Toggle how Donezo keeps your household
            in sync.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between gap-4 rounded-2xl border border-slate-200 p-4">
            <div>
              ...
              <p className="text-xs text-slate-500">
                Once-a-week recap of inventory
                changes and list progress.
              </p>
            </div>
            <button
              type="button"
